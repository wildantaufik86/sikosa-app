...
// create post
psikologRoutes.post("/articles", authenticate, validateRole("psikolog"), upload.single("thumbnail"), async (req, res) => {
  try {
...
// edit post
psikologRoutes.put("/articles/:id", authenticate, validateRole("psikolog"), upload.single("thumbnail"), async (req, res) => {
  try {
    const { id } = req.params;
    const { title, content } = req.body;
...
// delete post
psikologRoutes.delete("/articles/:id", authenticate, validateRole("psikolog"), async (req, res) => {
  try {
    const { id } = req.params;
