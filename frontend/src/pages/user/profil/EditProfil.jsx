...
const EditProfile = () => {
  return (
    <motion.section className="flex flex-col justify-center py-8 lg:py-10 px-6 lg:px-20 font-jakarta bg-white" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
      {/* Title */}
      ...
      <article className="w-full max-w-2xl lg:p-4 flex flex-col justify-center items-center mx-auto">
        <div className="flex flex-col md:flex-row">
          {/* Profile Image */}
          <motion.aside className="w-full md:w-1/2 flex justify-center items-center border border-black rounded-xl p-2 mb-4 md:mb-0" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ duration: 0.8, ease: "easeOut" }}>
            <img
          ...
          {/* Profile Details */}
          <motion.article className="w-full md:w-1/2 md:pl-8 flex flex-col justify-between" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.3 }}>
            ...
            <motion.div className="flex mt-4 space-x-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.4 }}>
              <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="bg-[#35A7FF] text-white text-sm font-semibold py-2 px-6 rounded-lg hover:bg-blue-600">
                Simpan
              </motion.button>
              <Link to="/profil" className="bg-[#35A7FF] text-white text-sm font-semibold py-2 px-6 rounded-lg hover:bg-blue-600">
                Kembali
              </Link>
            </motion.div>
          </motion.article>
